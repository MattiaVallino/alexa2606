...
module.exports = {
    async PostAlexaId(token,alexa_id){ // user id used for notification
      ...
      axios.default.timeout = 6500;
        ...
        const res = await axios
            ...
            .post(`https://intake-care-de7b20968242.herokuapp.com/notification-shcedulers`, data,
     ...
     async DeleteAlexaId(token,object_id){
      ...
      axios.default.timeout = 6500;
        ...
        const res = await axios
            ...
            .delete(`https://intake-care-de7b20968242.herokuapp.com/notification-shcedulers/${object_id}`, 
